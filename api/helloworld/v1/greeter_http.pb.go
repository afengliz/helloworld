...
func RegisterGreeterHTTPServer(s *http.Server, srv GreeterHTTPServer) {
	...
	r.POST("/v1/greeter/getuserbybucketcache", _Greeter_GetUserByBucketCache0_HTTP_Handler(srv))
}
...
func _Greeter_GetUserInfo0_HTTP_Handler(srv GreeterHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/helloworld.v1.Greeter/GetUserInfo")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Greeter_GetUserByBucketCache0_HTTP_Handler(srv GreeterHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in GetUserRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, "/helloworld.v1.Greeter/GetUserByBucketCache")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetUserByBucketCache(ctx, req.(*GetUserRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
type GreeterHTTPClient interface {
	GetUserByBucketCache(ctx context.Context, req *GetUserRequest, opts ...http.CallOption) (rsp *GetUserReply, err error)
...
func (c *GreeterHTTPClientImpl) GetUserByBucketCache(ctx context.Context, in *GetUserRequest, opts ...http.CallOption) (*GetUserReply, error) {
	var out GetUserReply
	pattern := "/v1/greeter/getuserbybucketcache"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation("/helloworld.v1.Greeter/GetUserByBucketCache"))
...
func (c *GreeterHTTPClientImpl) GetUserInfo(ctx context.Context, in *GetUserRequest, opts ...http.CallOption) (*GetUserReply, error) {
	var out GetUserReply
