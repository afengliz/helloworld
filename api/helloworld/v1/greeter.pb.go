...
var file_api_helloworld_v1_greeter_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xe4, 0x02, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65, 0x74,
	...
	0x6e, 0x67, 0x6c, 0x65, 0x66, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x3a, 0x01, 0x2a, 0x42, 0x54, 0x0a,
...
var file_api_helloworld_v1_greeter_proto_depIdxs = []int32{
	...
	3, // 3: helloworld.v1.Greeter.SayHello:output_type -> helloworld.v1.HelloReply
	1, // 4: helloworld.v1.Greeter.GetUserInfo:output_type -> helloworld.v1.GetUserReply
	1, // 5: helloworld.v1.Greeter.GetUserInfoBySingleFlight:output_type -> helloworld.v1.GetUserReply
